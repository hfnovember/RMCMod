...
/**
 * Generates uranium ore in the world.
 */
public class UraniumOreGen implements IWorldGenerator {

    private WorldGenerator uraniumOre;

    public UraniumOreGen() {
        uraniumOre = new WorldGenMinable(BlockInit.uraniumOre.getDefaultState(), 5);
    }//end UraniumOreGen()
    ...
    public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider) {
        switch (world.provider.getDimension()) {
            case 0: //Overworld
                runGenerator(uraniumOre, world, random, chunkX, chunkZ, 8, 5, 30);
                break;
            case 1: //End
                break;
            case -1: //Nether
